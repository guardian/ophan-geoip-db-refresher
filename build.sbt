...
libraryDependencies ++= Seq(
  ...
  "org.slf4j" % "log4j-over-slf4j" % "1.7.35", //  log4j-over-slf4j provides `org.apache.log4j.MDC`, which is dynamically loaded by the Lambda runtime
...
) ++ Seq("ssm", "s3", "url-connection-client").map(artifact => "software.amazon.awssdk" % artifact % "2.17.109")
